  ...
  return (
    <div>
      ...
      <div style={{ position: "fixed", zIndex: 2, bottom: 10, padding: 10 }}>
        <button  style={{backgroundColor:"red", padding:10, radius:10}} onClick={undo}>Undo</button>
        <button style={{backgroundColor:"green",padding:10,  radius:10, marginLeft:30}} onClick={redo}>Redo</button>
      </div>
